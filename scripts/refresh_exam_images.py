...
from refresh_external_content import ROOT, DATA, GEN, commons_search, commons_file, save_image, clean, now_iso, write_json_atomic
...
def main():
    ...
    for path in sorted(EXAMS.glob("*.json")):
        ...
        for node in walk(doc):
            ...
            image_file=clean(node.get("imageFile")) if isinstance(node,dict) else ""
            ...
            selected=commons_file(image_file) if image_file else None

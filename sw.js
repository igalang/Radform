const VERSION = 'radform-v8.3.1';
const SHELL_CACHE = `${VERSION}-shell`;
const IMAGE_CACHE = `${VERSION}-images`;
const CORE = [
  './','./index.html','./styles.css','./patch.css','./exam-prep.css','./app.js','./patch.js','./exam-prep.js','./supabase-client.js','./commons.js','./openi.js','./multicare.js','./mir-open.js',
  ...
  './data/exams/ebir-01.json','./data/exams/ebir-02.json','./data/exams/ebir-03.json',
  './data/exams/edir-01.json','./data/exams/edir-02.json','./data/exams/edir-03.json'
];
...
self.addEventListener('fetch',(event)=>{
  ...
  if(url.origin===self.location.origin){
    if(url.pathname.includes('/data/')||url.pathname.includes('/generated/')){event.respondWith(networkFirst(request));return;}
